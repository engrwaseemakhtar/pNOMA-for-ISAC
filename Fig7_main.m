...
RCS = 0:0.001:15; % Radar cross-section in square meters
R = 500; % Range from 1km to 10km in meters
dc = R;
snr_th = 1;
m=1;
m1=2;
...
[PD1,PD2,PD3,PD4] = fPD1m4(m,m1,m2,m3,Pr_sens,lambda,d_th);
% yyaxis right
...
% 
% yyaxis left
plot(RCS,PD1,RCS,PD2,RCS,PD3,RCS,PD4,MarkerSize=2);
xlabel('RCS')
ylabel('Sensing Probability of Detection (P_{D})')
legend(' m = 1' ,'m = 2','m = 3','m = 4','location','best');
grid on