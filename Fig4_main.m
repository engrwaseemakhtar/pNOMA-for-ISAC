...
freq = 1e9; % Radar frequency in Hz
c = 299792458; % Speed of light in m/s
lambda = c/freq; % Wavelength in meters
Pt = 100; % Transmitter power in Watts
Gt = 40; % Transmitter antenna gain in dB
Gr = 40; % Receiver antenna gain in dB
Gtr = 40; % Transmitter antenna gain in dB
Grr = 40; % Receiver antenna gain in dB
RCS = 10; % Radar cross-section in square meters
R = 0:5:500; % Range from 1km to 10km in meters
dc = R;
snr_th = .5;
m=4;
% Calculate path loss
...
yyaxis left
plot(R/1000,PD1,R/1000,PD2,R/1000,PD3,MarkerSize=2);
